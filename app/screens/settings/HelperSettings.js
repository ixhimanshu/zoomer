...
// Settings
export default class HelperSettings extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.contentContainerStyle}>
          ...
          <TouchableItem onPress={this.navigateTo('Notifications')}>
            <View style={[styles.row, styles.setting]}>
              <View style={styles.leftSide}>
                ...
                <Subtitle1 style={styles.mediumText}>Calls</Subtitle1>
              </View>
          ...
          <Setting
            onPress={this.navigateTo('HelperEditProfile')}
          ...
          <Setting
            onPress={this.navigateTo('AboutUs')}
            icon='bulb'
            title="Apply for More Categories"
          />
          <Divider type="inset" marginLeft={DIVIDER_MARGIN_LEFT} />

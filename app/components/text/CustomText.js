...
export const Heading7 = ({style, ...props}: Object): ReactElement<RNText> => (
  <RNText style={[styles.h7, style]} {...props} />
);

export const ErrorText = ({style, ...props}: Object): ReactElement<RNText> => (
  <RNText style={[styles.ErrorText, style]} {...props} />
);
